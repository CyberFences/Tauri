...
const MACHINE_REGISTRATION_ABI: &str = r#"
[
  {
    "inputs": [],
  ...
  {
    "inputs": [],
    "name": "getAllRegisteredMachineIds",
    "outputs": [
      {
        "internalType": "string[]",
        "name": "",
  ...
  {
    "inputs": [],
    "name": "getTotalRegisteredMachines",
    "outputs": [
      {
